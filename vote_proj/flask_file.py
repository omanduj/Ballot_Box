...
avatars = Avatars(app)                                          #Used to obtain personal Avatars for users based on their emails
client = pymongo.MongoClient('mongodb://localhost:27017/')      #connect to db
db = client.user_login_system                                   #this creates database with the name user_login_system, and associated it with variable db
